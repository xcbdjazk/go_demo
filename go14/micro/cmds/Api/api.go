...
import (
	...
	api2 "go_example/go14/micro/cmds/Api/proto"
	"log"
)
...
func main() {
	...
	api2.RegisterExampleHandler(service.Server(), new(Example))

	// register foo handler
	api2.RegisterFooHandler(service.Server(), new(Foo))
